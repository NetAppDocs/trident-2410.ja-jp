...
.タスク概要
* アップグレード後に発生したバグ、依存関係の問題、またはアップグレードの失敗や不完全な場合の修正が必要な場合は、Astra Tridentをアンインストールして、そのバージョン専用の手順に従って以前のバージョンを再インストールしてください。これは、以前のバージョンに_ダウングレード_するための唯一推奨される方法です。
