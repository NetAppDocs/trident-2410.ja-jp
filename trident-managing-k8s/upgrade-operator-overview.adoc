...
TIP: Kubernetes クラスター上の Astra Trident アーキテクチャの詳細については、link:../trident-get-started/intro.html#astra-trident-architecture["Astra Tridentアーキテクチャ"]を参照してください。
